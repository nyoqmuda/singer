...
links3="sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/nyoqmuda/singer/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh"
clear
...
echo "  Script Ver    : Multiport_KURITA"
echo -e "\033[0;34m----------------------------------------\033[0m"
...
clear
echo -e "\033[0;34m----------------------------------------\033[0m"
echo -e "\E[44;1;39m    MENU ADD IP MULTIPORT WS KURITA  \E[0m"
echo -e "\033[0;34m----------------------------------------\033[0m"
echo ""
...
echo -e ""
echo -e "\033[0;34m----------------------------------------\033[0m"
echo -e "\E[44;1;39m      SCRIPT MULTIPORT WS KURITA     \E[0m"
echo -e "\033[0;34m----------------------------------------\033[0m"
echo ""
